class ServiceProviderDetailModel {
  ServiceProviderDetailData? data;
  String? message;
  String? status;

  ServiceProviderDetailModel({this.data, this.message, this.status});

  ServiceProviderDetailModel.fromJson(Map<String, dynamic> json) {
    data = json['data'] != null
        ? ServiceProviderDetailData.fromJson(json['data'])
        : null;
...
class ServiceProviderDetailData {
  String? id;
  String? userName;
  String? email;
  String? mobile;
  ...
  ServiceProviderDetailData.fromJson(Map<String, dynamic> json) {
    id = json['id'];
